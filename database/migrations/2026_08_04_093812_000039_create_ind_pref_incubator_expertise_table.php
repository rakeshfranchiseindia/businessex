...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('ind_pref_incubator_expertise', function (Blueprint $table) {
            $table->integer('incubator_ind_pref_id')->autoIncrement();
    ...
    {
        Schema::dropIfExists('ind_pref_incubator_expertise');
    }
};