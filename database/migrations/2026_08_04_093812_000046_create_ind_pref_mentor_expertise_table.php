...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('ind_pref_mentor_expertise', function (Blueprint $table) {
            $table->integer('mentor_ind_pref_id')->autoIncrement();
    ...
    {
        Schema::dropIfExists('ind_pref_mentor_expertise');
    }
};