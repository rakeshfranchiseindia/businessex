...
class ContactBusinessTableSeeder extends Seeder
{
    /**
    ...
    {
        DB::table('contact_business')->insert([
            'contact_id' => 1,
            'profile_str' => 'BSN0001',
            'user_id' => 1,
            'profile_id' => 1,
            ...
            'contact_purchase_time' => 'Within 3 months',
        ...
        DB::table('contact_business')->insert([
            ...
            'contact_purchase_time' => 'Within 6 months',
        ...
        DB::table('contact_business')->insert([
            ...
            'contact_purchase_time' => 'Exploring options',
