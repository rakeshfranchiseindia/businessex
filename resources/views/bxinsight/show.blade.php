    ...
    <footer class="site-footer">
        ...
        <div class="footer-group-companies">
            <div class="container">
                ...
                <div class="group-companies-logos">
                    <img src="https://www.franchiseindia.com/images/logo.png" alt="Franchise India">
                    <img src="https://www.dealerindia.com/images/logo.png" alt="Dealer India">
                    <img src="https://www.indianretailer.com/images/logo.png" alt="Indian Retailer">
                    <img src="https://restaurantindia.in/images/logo.png" alt="Restaurant India">
                    <img src="https://francorp.in/images/logo.png" alt="Francorp">
                    <img src="https://franglobal.com/images/logo.png" alt="FranGlobal">
                    <img src="https://entrepreneur.co.in/images/logo.png" alt="Entrepreneur">
                    <img src="https://licenseindia.com/images/logo.png" alt="License India">
                    <img src="https://isfa.org.in/images/logo.png" alt="ISFA">
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-6 mb-4">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Automobile Electric Vehicles</a></li>
                            <li><a href="#">Automobile Insurance</a></li>
                            <li><a href="#">Automobile Maintenance & Repair</a></li>
                        </ul>
                    </div>
                    
                    <!-- Column 2 -->
                    <div class="col-lg-3 col-md-4 col-6 mb-4">
                        <h5>Beauty, Health & Wellness</h5>
                        <ul>
                            <li><a href="#">Ambulance Healthcare Service</a></li>
                            <li><a href="#">Beauty Salons</a></li>
                            <li><a href="#">Beauty Equipments</a></li>
                            <li><a href="#">Beauty Parlour For Sale Near Me</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-6 mb-4">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Brick & Cement</a></li>
                            <li><a href="#">Building Roofing & Flooring</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-6 mb-4">
                        ...
                        <ul>
                            <li><a href="#">Advertisement & Media Services</a></li>
                            <li><a href="#">BPO</a></li>
                            <li><a href="#">Book Publishing</a></li>
                            <li><a href="#">Broadcasting Services</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-6 mb-4">
                        <h5>Education</h5>
                        <ul>
                            <li><a href="#">Child Care Centers For Sale</a></li>
                            <li><a href="#">Coaching & Training Institutes</a></li>
                            <li><a href="#">Colleges</a></li>
                            <li><a href="#">Day Care Center For Sale</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-6 mb-4">
                        ...
                        <ul>
                            <li><a href="#">Biofuel</a></li>
                            <li><a href="#">Environment Related</a></li>
                            <li><a href="#">Gas & Petroleum Stations</a></li>
                            <li><a href="#">LPG Dealers</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-6 mb-4">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Clothing Business Sale In India</a></li>
                    ...
                    <div class="col-lg-3 col-md-4 col-6 mb-4">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Bitcoin Business For Sale</a></li>
                            <li><a href="#">Consumer Leasing</a></li>
        ...
        <div class="footer-copyright">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <p>&copy; 2021 to 2022 BusinessEx. All rights reserved.</p>
                    </div>
                    <div class="col-md-6 text-md-right">
