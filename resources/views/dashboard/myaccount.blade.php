        ...
        <div class="col-md-3">
            <div class="card shadow-sm">
                <div class="card-body text-center">
                    <img src="{{ asset('assets/images/profile-dflt.gif') }}" class="rounded-circle mb-2" width="80" alt="Profile">
                    ...
                    <ul class="list-group text-left">
                        ...
                        <li class="list-group-item"><i class="fa fa-eye"></i> Profile Views <span class="badge badge-secondary float-right">0</span></li>
                        <li class="list-group-item"><i class="fa fa-user"></i> My Profile</li>
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="media mb-4">
                        <img src="{{ asset('assets/images/category/small/6.jpg') }}" class="mr-3 rounded" width="100" alt="Listing">
                    ...
                    <!-- Listing 2 -->
                    <div class="media mb-4">
                        <img src="{{ asset('assets/images/category/small/10.jpg') }}" class="mr-3 rounded" width="100" alt="Listing">
                        <div class="media-body">
                    ...
                    <!-- Listing 3 -->
                    <div class="media mb-4">
                        <img src="{{ asset('assets/images/category/small/5.jpg') }}" class="mr-3 rounded" width="100" alt="Listing">
                        <div class="media-body">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <ul class="list-unstyled">
                        <li class="media mb-3">
                            <img src="{{ asset('assets/images/category/small/6.jpg') }}" class="mr-3 rounded" width="60" alt="Recommendation">
                            <div class="media-body">
                        ...
                        <li class="media mb-3">
                            <img src="{{ asset('assets/images/category/small/10.jpg') }}" class="mr-3 rounded" width="60" alt="Recommendation">
                            <div class="media-body">
                        ...
                        <li class="media mb-3">
                            <img src="{{ asset('assets/images/category/small/5.jpg') }}" class="mr-3 rounded" width="60" alt="Recommendation">
                            <div class="media-body">
