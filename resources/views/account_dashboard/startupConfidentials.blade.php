            ...
            <form action="{{ route('startup.headquarters.ajax.update', $user->user_rand_id) }}" method="POST" id="headquartersForm">
                ...
                <div class="row">
                    <div class="col-md-4 form-group"><label>City <span class="text-danger">*</span></label>
                        <input type="text" id="ofc_city" name="ofc_city" class="form-control" value="{{ $startup->ofc_city ?? '' }}" required></div>
                    <div class="col-md-4 form-group"><label>State</label>
                        <input type="text" id="ofc_state" name="ofc_state" class="form-control" value="{{ $startup->ofc_state ?? '' }}"></div>
                    <div class="col-md-4 form-group"><label>Country</label>
                        <input type="text" id="ofc_country" name="ofc_country" class="form-control" value="{{ $startup->ofc_country ?? '' }}"></div>
                </div>
