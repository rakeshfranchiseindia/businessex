...
class BusinessProfileController extends Controller
{
    ...
    public function storeBusinessProfile(Request $request)
    {
        $validated = $request->validate([
            ...
            'company_name' => ['required', 'string', 'min:15', 'max:50'],
            ...
            'inventory_value' => ['nullable', 'integer'],
            'ebitda' => ['nullable', 'integer'],
            'gross_income' => ['nullable', 'integer'],
            'ebitda_margin' => ['nullable', 'integer'],
            'rentals' => ['nullable', 'integer'],
            'company_summary_financial' => ['nullable', 'string'],
        ], [
